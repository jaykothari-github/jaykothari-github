# Hi there, I'm Jay! 👋
### ![Python](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/960px-Python-logo-notext.svg.png) Python Developer | Aspiring Machine Learning Engineer
...
### 🔭 What I'm working on
- 🛠️ Developing scalable web applications using **Django** and **Flask**.
- ☁️ Architecting cloud solutions on **Google Cloud Platform (GCP)**.
- 🤖 Deep diving into **Machine Learning** algorithms and data science workflows.
- 📈 Mastering ETL pipelines and Big Data analytics with **BigQuery**.
